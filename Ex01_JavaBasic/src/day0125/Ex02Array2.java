...
public class Ex02Array2 {
    public static void main(String[] args) {
        //1. 크기가 4인 int 배열을 만들어서 3, -4, 22, 11 을 넣어보세요
        ...
        //2. 크기가 3인 String 배열을 만들어서 "김철수", "이영희", "Jane Doe"를 넣어보세요
        ...
        //단, 사용자가 범위를 벗어난 값을 입력하면 올바른 범위의 값이 들어올 때까지 다시 입력을 받으세요
        ...
        for(int i = 0; i < intArray2.length; i++) {
            System.out.printf("stringArray2[%d]: %s \n", i, intArray2[i]);
        }
