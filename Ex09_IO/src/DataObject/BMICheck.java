...
public class BMICheck {
    ...
    private void save() {
        ...
        try{
            ...
            ObjectOutputStream oos = new ObjectOutputStream(fos); //분해해서 저장 : 직렬화 
    ...
    private void print() {
        //순서가 없는 집합인 Set으로 키 값을 받고
        Set<Integer> set = map.keySet();
        System.out.println("번호\t키\t몸무게\t결과\t판정");
        //hashmap의 value인 BMI정보를 받아서 BMI클래스에 선언된 get함수들을 사용해 값을 받아 출력 
    ...
    private void add() {
        BMI bmi = new BMI();
        //BMI클래스에 선언된 input함수를 통해 값을 할당한 BMI객체를 HashMap 안에 input  
    ...
    private void load() {
        ...
        try{
            ...
            //직렬화된 데이터를 해시맵형태로 가져와서 효율적으로 데이터에 접근함 
