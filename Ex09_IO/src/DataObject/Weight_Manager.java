...
public class Weight_Manager {
    ...
    File f;
    File fd= new File("/Users/joohyun/java_test"); //파일이 생성될곳
 ...
 public void inputWeight() throws IOException{
        ...
        File f= new File("/Users/joohyun/java_test"+this.str_name+".txt"); //기록할 파일객체 생성
        ...
        if( !f.exists()){      
            ...
            bw.close();
            System.out.println("___입력이 완료되어_..[ /Users/joohyun/java_test"+this.str_name+".txt ]._가(이) 생성되었습니다.");
        }else{
